# pISA-tree: Standard project directory tree (ISA structure compliant)
...
2. Extract files from in the subdirectory ***main*** into your local pISA projects directory.
